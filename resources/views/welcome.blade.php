...
<head>
    ...
    <title>Formad.id</title>
    <meta content="" name="description">
    <meta content="" name="keywords">

    <!-- Favicons -->
    <link href="{{ asset('assets_user/assets/img/favicon.png') }}" rel="icon">
    <link href="{{ asset('assets_user/assets/img/apple-touch-icon.png') }}" rel="apple-touch-icon">
